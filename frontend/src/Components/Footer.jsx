        ...
        <div className="bottom">
          ...
          <div className="pt-2 flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col justify-between items-center gap-2 text-gray-500 ">
              <h2 className="font-bold text-3xl text-gray-300">GigSetu.</h2>
              <a href="#" className="block text-sm">
                © GigSetu Ltd. 2025
              </a>
            </div>
            <Link to="https://github.com/Birendra23">
              <p className="flex gap-2 items-center text-lg hover:text-gray-300 cursor-pointer">
                Developed by <BsGithub />{" "}
                <span className="font-semibold"> Birendra Pratap Singh </span>
              </p>
            </Link>
            <div className="flex flex-col md:flex-row justify-between items-center gap-14 mt-4 md:mt-0">
              <div className="flex gap-8 items-center">
                ...
                <Link to="https://www.linkedin.com/in/birendra-pratap-singh-bps2618/">
                  <FaLinkedin size={35} className="cursor-pointer" />
                </Link>
                <Link to="https://leetcode.com/u/Birendra2618/">
